    ...
    <div className="h-full w-full flex flex-col lg:flex-row lg:overflow-hidden">
      ...
      <div className="w-full dark:text-black  lg:w-[50%] flex items-center justify-center px-4 py-4 sm:px-6 lg:px-8 lg:py-0">
        <form
          ...
          className="w-full max-w-xl rounded-2xl border dark:bg-gray-500 border-gray-500 bg-white dark:text-black  p-4 shadow-2xl sm:p-6 lg:p-6 lg:max-h-[90vh]"
          action=""
        >
          ...
          <div className="mt-4 flex flex-col gap-4 sm:flex-row">
            <div className="w-full sm:w-1/2">
              <label
                className="mb-2 block text-lg font-semibold sm:text-xl"
                htmlFor=""
              >
                First Name
              </label>
          ...
          <button className="mt-4 flex h-12 w-full items-center justify-center rounded-2xl bg-black text-xl font-bold text-white shadow-md transition cursor-pointer hover:bg-gray-600 sm:h-14 sm:text-2xl">
            Sign Up
          </button>
          <p className="mt-3 text-center text-sm sm:text-base">
            Already have an account?{" "}
            <Link to={"/login"}>
              <span className="cursor-pointer underline dark:text-black  text-gray-500">
                Sign in
              </span>
            </Link>
          </p>
